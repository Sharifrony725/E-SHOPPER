<?php 
    if(isset($_POST['btn'])){
        $message = $ob_sub_admin->save_manufacture_info($_POST);
    }
						...
						<form class="form-horizontal" action="" method="POST">
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input name="manufacturer_name" type="text" placeholder="enter manufacturer  name" class="s" id=""  data-provide="" data-items="">
							  </div>
							</div>
							...
							<div class="form-actions">
							  <button name="btn" type="submit" name="" class="btn btn-primary">Save Manufacturer     Info</button>
