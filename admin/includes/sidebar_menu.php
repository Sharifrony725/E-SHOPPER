<div id="sidebar-left" class="span2">
	<div class="nav-collapse sidebar-nav">
		<ul class="nav nav-tabs nav-stacked main-menu">
			...
			<li><a href="manufacture.php"><i class="icon-eye-open"></i><span class="hidden-tablet">Add Manufacturer </span></a></li>
			<li><a href="manage_manufacture_content.php"><i class="icon-dashboard"></i><span class="hidden-tablet"> Manage Manufacturer</span></a></li>
